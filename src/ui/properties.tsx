    ...
    <section className="sidebar-section" aria-label="Properties">
      ...
      {selectedNode ? (
        <div className="property-group">
          <section className="property-subsection">
            <PropertySubsectionHeader title="Editable inputs" />
          ...
          <section className="property-subsection">
            <PropertySubsectionHeader title="Details" />
          ...
          {selectedNodeFittings.length > 0 ? (
            <section className="property-subsection">
              <PropertySubsectionHeader
                title="Automatic fitting losses"
                help="Edit zeta values here; pressure loss values below are calculated."
              />
      ...
      {selectedComponent?.type === "ahu" ? (
        <div className="property-group">
          ...
          <section className="property-subsection">
            <PropertySubsectionHeader title="Calculated results" />
            <div className="property-metric-grid">
              <div className="property-meta">
              ...
              <div className="property-meta">
                <span>Fan state</span>
                <strong>{selectedComponent.metadata.fanRunning ? "Running" : "Stopped"}</strong>
              </div>
            </div>
          </section>
        </div>
          ...
          <section className="property-subsection">
            ...
            <div className="property-metric-grid">
              <div className="property-meta">
                ...
                <strong>{formatFlow(selectedComponent.flow.designFlowRateLps)}</strong>
              </div>
              <div className="property-meta">
                <span>Total pressure loss</span>
                <strong>{formatPressure(selectedComponentResult?.totalPressureLossPa)}</strong>
      ...
      {selectedComponent?.type === "ductSegment" ? (
        <div className="property-group">
          ...
          <section className="property-subsection">
            <PropertySubsectionHeader title="Network context" />
            <div className="property-meta">
              <span>Length</span>
